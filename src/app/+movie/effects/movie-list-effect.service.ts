...
import { map, exhaustMap, catchError } from 'rxjs/internal/operators';
...
export class MovieListEffectService {
  ...
  public getList: Observable<Action> = this.actions$.pipe(
    ...
    exhaustMap(() => this.movieService.getMovies()),
  ...
  public delete$: Observable<Action> = this.actions$.pipe(
    ...
    map(toPayload),
    exhaustMap((movie) => this.movieService.deleteMovie(movie.id)),
